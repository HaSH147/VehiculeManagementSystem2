...
import { ImageBackground, View, Text, Button, StyleSheet, SafeAreaView, ScrollView, StatusBar, Image, TouchableOpacity } from 'react-native';
    ...
    mainExample (number, title) {
        ...
        return (
            <View style={styles.exampleContainer}> 
                <Text></Text>               
                <Text style={styles.subtitle}>Notre application mobile vous offre le meilleur des services possibles pour en profiter pleinement </Text>
                <Text></Text><Text></Text>
                <Text style={{color: '#616247FF', fontSize: 19, marginLeft: 80, alignItems:'center', fontWeight:'bold'}}>Découvrez-Les ci-dessous</Text><Text></Text>
                <Carousel
